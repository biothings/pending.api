...
def merged_mapping(cls) -> dict:
    mapping = {
        "properties": {
            ...
            "id": {"type": "long"},
            "kg2_ids": {"type": "text", "fields": {"keyword": {"type": "keyword", "ignore_above": 256}}},
            "knowledge_level": {"type": "text", "fields": {"keyword": {"type": "keyword", "ignore_above": 256}}},
            "object": {
                "properties": {
                    "all_categories": {"type": "text", "fields": {"keyword": {"type": "keyword", "ignore_above": 256}}},
                    "all_names": {"type": "text", "fields": {"keyword": {"type": "keyword", "ignore_above": 256}}},
            ...
            "publications_info": {
                "properties": {
                    "object_score": {"type": "text", "fields": {"keyword": {"type": "keyword", "ignore_above": 256}}},
                    "pmid": {"type": "text", "fields": {"keyword": {"type": "keyword", "ignore_above": 256}}},
                    "publication_date": {
                        "type": "text",
                        "fields": {"keyword": {"type": "keyword", "ignore_above": 256}},
                    ...
                    "subject_score": {"type": "text", "fields": {"keyword": {"type": "keyword", "ignore_above": 256}}},
                }
            },
            "qualified_object_aspect": {
                "type": "text",
            ...
            "qualified_predicate": {"type": "text", "fields": {"keyword": {"type": "keyword", "ignore_above": 256}}},
            "subject": {
                "properties": {
                    "all_categories": {"type": "text", "fields": {"keyword": {"type": "keyword", "ignore_above": 256}}},
                    "all_names": {"type": "text", "fields": {"keyword": {"type": "keyword", "ignore_above": 256}}},
