  ...
  <section>
      ...
      <div class="container">
        ...
        <template v-else>
          <section class="jumbotron bg-none mb-0 text-left">
            ...
            <h3 class="  mb-4">Made for <a class="text-underline" href="https://ncats.nih.gov/translator" target="_blank" rel="noreferrer">NCATS Biomedical Data Translator</a> Program</h3>
    ...
    <div id="pending" class="  text-center">
      ...
      <div class="container py-3">
        <div>
          <form class="p-2">
            <label class="mr-4" for="search">(<span class="" style="font-family: sans-serif;" v-text="apiStore.apis.length"></span>) APIs</label>
            <input v-model="query" type="text" name="search"
            class="bg-white placeholder:text-main-light text-main-dark w-50 px-2" placeholder="Filter by name" 
          ...
          <div class="d-flex justify-content-center align-items-center p-3">
            <div>
              ...
              <template v-for="type in apiStore.biothing_types" :key="type.name">
                <span class="entity-badge badge border border-light m-1 pointer" 
          ...
          <div class="api-main-container">
            <table class="w-100 table table-striped table-hover table-sm text-left table-hover mb-5" id="pending-api-table">
              <colgroup>
                <col span="1">
                <col span="1">
                <col span="1">
                </colgroup>
              <thead class="bg-med sticky-top top-0">
                  <tr>
                    <th class="p-1" scope="col" @click="sortBy(0, false)">Name <i class="fas fa-sort" style="float:right;margin-top:3px"></i></th>
                    <th scope="col" class="p-1 d-none d-md-table-cell" @click="sortBy(1, true)">Documents <i class="fas fa-sort" style="float:right;margin-top:3px"></i></th>
                    <th class="p-1" scope="col" @click="sortBy(2, false)">Entity Type <i class="fas fa-sort" style="float:right;margin-top:3px"></i></th>
                  </tr>
                </thead>
                <tbody>
        ...
        <div class="container d-flex justify-content-center align-items-start mb-4">
          <div class="mx-4 card bg-main-muted shadow">
            <div class="card-body">
              ...
              <a rel="noopener" class="btn btn-dark" target="_blank" href="http://docs.biothings.io/en/latest/doc/studio.html" title="BioThings Studio">
          ...
          <div class="mx-4 card bg-main-muted shadow">
            ...
            <div class="card-body">
              <h2 class=" main-font card-title">
                Build Your Own API
              </h2>
              <a rel="noopener" class="btn btn-dark" target="_blank" href="https://biothingsapi.readthedocs.io/en/latest/doc/studio.html">
